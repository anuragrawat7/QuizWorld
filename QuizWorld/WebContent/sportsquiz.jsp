...
<body>
	...
	<div class = "container" id = "content">
		<h1 class="display-5" style = "color:#DF752E">Sports Quiz</h1>
		<hr noshade>
		<div class = "row">
			<div class = "col-sm-8">
			</div>
			<div class = "col-sm-4" style=" height : 487px;">
				...
				<% session.setAttribute("quizname","sportsquiz"); %>
		...
		<div id = "about">
			...
			<p style = "font-size:18px;">Sport includes all forms of competitive physical activity or games which, through
			 casual or organised participation, aim to use, maintain or improve physical ability and skills while providing
			 enjoyment to participants, and in some cases, entertainment for spectators.[2] Hundreds of sports exist, 
			 from those between single contestants, through to those with hundreds of simultaneous participants, either 
			 in teams or competing as individuals. In certain sports such as racing, many contestants may compete, 
			 simultaneously or consecutively, with one winner; in others, the contest (a match) is between two sides, 
			 each attempting to exceed the other. Some sports allow a "tie" or "draw", in which there is no single winner; 
			 others provide tie-breaking methods to ensure one winner and one loser. A number of contests may be arranged 
			 in a tournament producing a champion.</p>
		</div>
	</div>
	<!-- Footer -->
