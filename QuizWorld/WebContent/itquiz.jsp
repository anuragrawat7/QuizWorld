...
<body>
	...
	<div class = "container" id = "content">
		<h1 class="display-5" style = "color:#2DDFB0">Information Technology Quiz</h1>
		<hr noshade>
		<div class = "row">
			<div class = "col-sm-8">
			</div>
			<div class = "col-sm-4" style=" height : 487px;">
				...
				<% session.setAttribute("quizname","itquiz"); %>
		...
		<div id = "about">
			...
			<p style = "font-size:18px;">Information technology (IT) is the use of computers to store, retrieve,
			 transmit, and manipulate data, or information, often in the context of a business or other enterprise.
			 IT is considered to be a subset of information and communications technology (ICT). An information
			 technology system (IT system) is generally an information system, a communications system or, more specifically 
			 speaking, a computer system including all hardware, software and peripheral equipment operated by a 
			 limited group of users. Humans have been storing, retrieving, manipulating, and communicating information 
			 since the Sumerians in Mesopotamia developed writing in about 3000 BC, but the term information technology
			 in its modern sense first appeared in a 1958 article published in the Harvard Business Review; authors 
			 Harold J. Leavitt and Thomas L. Whisler commented that "the new technology does not yet have a single 
			 established name. We shall call it information technology (IT)."</p>
		</div>
	</div>
	<!-- Footer -->
